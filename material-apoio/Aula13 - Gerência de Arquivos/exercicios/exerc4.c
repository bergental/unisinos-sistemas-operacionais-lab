    ...
    if(fd == -1) {
        ...
        */
        ...
        for (size_t i = 0; i < sizeof(conteudo); i++)
            if(conteudo[i] == '\n') countLinhas++;
            else if(conteudo[i] == ' ') countEspacos++;
            else if(conteudo[i] == 'a' || conteudo[i] == 'A' ||
            conteudo[i] == 'e' || conteudo[i] == 'E' ||
            conteudo[i] == 'i' || conteudo[i] == 'I' ||
            conteudo[i] == 'o' || conteudo[i] == 'O' ||
            conteudo[i] == 'u' || conteudo[i] == 'U') countVogais++;
